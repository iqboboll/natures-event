            ...
            if res_my.status_code == 200:
                ...
                for item in items[:6]:
                    ...
                    live_items.append({
                        ...
                        "time": "MALAYSIA NEWS", "text": title, "url": link,
                        "tag": "MY: BERNAMA", "tagColor": "var(--accent-cyan)",
                        "timestamp": datetime.now(timezone.utc)
                    })
        except Exception: pass
        ...
        try:
            ...
            if res_intl.status_code == 200:
                ...
                for item in items[:6]:
                    ...
                    live_items.append({
                        "id": md5(link.encode()).hexdigest(),
                        "time": "INTERNATIONAL", "text": title, "url": link,
                        "tag": "GLOBAL ALERT", "tagColor": "var(--accent-red)",
                        "timestamp": datetime.now(timezone.utc)
                    })
        except Exception: pass
